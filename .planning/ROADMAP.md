...
- [x] 04-03-PLAN.md — ReceitaPage end-to-end (4 cards + breakdown + LineChart 6m+3m + lista renovações 30/60/90 + sem data_fim) + rota /receita + nav sidebar gated coordenador+ (REV-01/02/03 — UI slice)
