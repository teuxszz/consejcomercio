...
- [x] 05-04-PLAN.md — Portal cliente: página `/portal/preferencias` placeholder preparando Phase 7 (EMAIL-01)
...
- [x] 06-05-PLAN.md — Install banner + AppLayout SW listener + page hooks TarefasPage/IndicacoesPage para ?highlight=<id> + UAT manual 8 itens (PUSH-01, PUSH-04)
...
- [x] 999.1-02-PLAN.md — Cofre google_calendar_tokens (RLS zero-leitura + RPCs) + _shared/google-calendar.ts (refresh/create/getValidAccessToken) (wave 1) (SLA-06)
- [x] 999.1-03-PLAN.md — Motor de dispatch: _shared/sla.ts (CAS + DM sempre + Calendar/fallback + escalação fail-safe) + edge function notify-sla-evento (wave 2) (SLA-04, SLA-05, SLA-07)
- [x] 999.1-04-PLAN.md — Cron scan (migration 043 cron_sla_scan 15min fail-closed) + smoke checkpoint (wave 3) (SLA-05, SLA-07)
- [x] 999.1-05-PLAN.md — UI conectar Google Agenda em /me (hook + ConectarGoogleAgendaCard + captura pós-redirect) (wave 2) (SLA-08)
- [x] 999.1-06-PLAN.md — UI config de prazos de SLA por fase em /configuracoes (SlaFollowupConfig) (wave 2) (SLA-09)
