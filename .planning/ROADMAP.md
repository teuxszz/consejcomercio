...
Plans:
- [ ] 06-01-PLAN.md — Foundation + de-risk: migration 036 (push_subscriptions + CHECK canal + handle_new_user + backfill) + types (CanalNotif/PreferenciasNotif/PushSubscriptionRow) + R-L1 smoke-test (esm.sh vs npm: web-push) + Wave 0 test scaffolds + push-mocks (PUSH-01, PUSH-02, PUSH-03)
- [ ] 06-02-PLAN.md — PWA shell installable: public/manifest.json + public/sw.js + ícones 192/512 + index.html PWA meta tags + main.tsx SW registration + vercel.json cache control (PUSH-01, PUSH-04)
...
| 6. PWA + Push Notifications | 0/5 | Planned | - |
